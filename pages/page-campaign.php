                  ...
                  <?php elseif ($f['type'] == 'Project Selector') : ?>
                    <div class="inpg projectSelector <?php echo $size; ?>" data-type="checkbox-project">
                      ...
                      <?php foreach ($f['project_selector_listed'] as $c) : ?>
                        ...
                        if ($project['project_code'] === '' || $project === NULL) {
                          $project_new_fields = get_field('project_informations', $psid);
                          $code = $project_new_fields['project_code'];
                        } else {
                          ...
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" value="<?php echo $code; ?>" data-dbName="<?php echo $dbname; ?> "
                                  data-pname="<?php echo strip_tags($c['checkbox_label']); ?>" data-projectCode="<?php echo $code; ?>">
                              <?php echo $c['checkbox_label']; ?>
                            </label>
                          </div>
                        </div>
